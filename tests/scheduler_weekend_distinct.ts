...
browserTest(
  "Distinct Weekend Fairness - Separately balances Sat and Sun",
  async () => {
    ...
    assertEquals(
      sunCounts["1"] + sunCounts["2"],
      5,
      "Total Sundays should be 5",
    );
  },
);

browserTest(
  "Distinct Weekend Fairness - Sat and Sun don't interfere with each other",
  async () => {
    const settings: Settings = {
